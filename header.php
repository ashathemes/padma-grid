...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'padma-grid' ); ?></a>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<button class="screen-reader-text menu-close"><?php esc_html_e( 'Close Menu', 'padma-grid' ); ?></button>
					<div class="mainmenu">
						<?php
							wp_nav_menu( array(
